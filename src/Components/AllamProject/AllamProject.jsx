...
import logo from "../../assets/allam-logo.png";
import img from "../../assets/allam.png";
import style from "./AllamProject.module.css";
import { HiArrowRightCircle } from "react-icons/hi2";
import { HiArrowLongRight } from "react-icons/hi2";
import { HiArrowLongLeft } from "react-icons/hi2";

export default function AllamProject() {
  return (
          ...
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                his WordPress project is a fully customized and responsive Hajj
                & Umrah service platform designed to guide users through all
                essential pilgrimage information with clarity and ease. The
                website provides structured sections for travel packages,
                service details, accommodation options, pricing plans, and
                step-by-step guidance for pilgrims. Built with WordPress, it
                uses a clean and modern UI, optimized performance, and custom
                components such as dynamic forms, booking sections, and easily
                manageable content through the WordPress dashboard. The project
                focuses on providing a smooth user experience, ensuring
                accessibility, fast loading, and clear navigation for anyone
                planning their pilgrimage journey.
              </p>
            </div>

            <div className="btn mt-5">
              <Link
                to="https://alam-albasher.com.sa/"
