...
import img from "../../assets/Startup-Portfolio.png";
import style from "./StartUpProject.module.css";
      ...
      <div className="md:px-14 px-6 mx-auto">
        <div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-y-5">
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            <div className="logo-of-project my-6"></div>
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                A modern and responsive portfolio landing page for a new
                company, designed to showcase services, projects, and company
                strengths. The page highlights team expertise, completed
                projects, client testimonials, and contact information,
                providing a clean and professional presentation for potential
