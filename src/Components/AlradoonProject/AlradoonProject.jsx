...
import logo from "../../assets/alradoon-logo.png";
import img from "../../assets/alradoon.png";
import style from "./AlradoonProject.module.css";
import { HiArrowRightCircle } from "react-icons/hi2";
import { HiArrowLongRight } from "react-icons/hi2";
import { HiArrowLongLeft } from "react-icons/hi2";

export default function AlradoonProject() {
  return (
    <section className="md:my-30 mb-20 mt-30">
      <div className="md:px-14 px-6 mx-auto">
        <div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-y-5">
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            <div className="logo-of-project my-6">
              <img src={logo} alt="princess natural" width={80} />
            </div>
        ...
        <div className="techtools">
          ...
          A clean and responsive charity platform focused on donations, water wells, and humanitarian projects.
The page highlights donation categories, ongoing campaigns, and project progress, making it easy for users to contribute with trust and transparency.
Designed with a simple and smooth user experience to inspire generosity and support impactful causes.
              </p>
            </div>

            <div className="btn mt-5">
              <Link
                to="https://alraedooon.com/"
