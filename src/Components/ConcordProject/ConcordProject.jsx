...
import img from "../../assets/concord.png";
import style from "./ConcordProject.module.css";
import { HiArrowRightCircle } from "react-icons/hi2";
import { HiArrowLongRight } from "react-icons/hi2";
import { HiArrowLongLeft } from "react-icons/hi2";

export default function ConcordProject() {
  return (
          ...
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                A modern and responsive landing page for an English learning
                course, designed to showcase course content, levels, and
                teaching methods. The page highlights benefits, curriculum,
                testimonials, and enrollment options, providing a clear and
                engaging user experience for learners of all levels.
              </p>
            </div>
