...
export default function MejazProject() {
  return (
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-y-5">
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            <div className="logo-of-project my-6">
              <img src={logo} alt="princess natural" width={85} />
            </div>
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                This project focuses on delivering a clean UI for a This Coffee
                Landing Page is a warm, modern, and visually rich design built
                The page showcases the unique experience of premium coffee —
                from its rich aroma to its handcrafted brewing process. It
                highlights product details, specialty blends, customer
                favorites, and the story behind the brand, all presented in a
                smooth and elegant layout. With responsive design, subtle
                animations, and interactive elements, the landing page creates
                an immersive coffee experience that works across all devices.
              </p>
            </div>

            <div className="btn mt-5">
              <Link
                to="https://mejaz.vercel.app/"
