...
import img from "../../assets/daniels.png";
import style from "./Daniels.module.css";
import { HiArrowRightCircle } from "react-icons/hi2";
import { HiArrowLongRight } from "react-icons/hi2";
import { HiArrowLongLeft } from "react-icons/hi2";

export default function DanielsProject() {
  return (
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-y-5">
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            <div className="logo-of-project my-6">
              <h2 className="text-2xl">Daniels</h2>
            </div>
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                Daniels Portfolio is a modern and visually engaging personal
                portfolio landing page built using HTML5, CSS3, Bootstrap, and
                JavaScript. The page is designed to highlight professional
                skills, showcase projects, and present personal information in a
                clean and elegant layout. It includes smooth scrolling, animated
                sections, interactive components, and a fully responsive design
            ...
            <div className="btn mt-5">
              <Link
                to="https://habibakhaled13.github.io/Daniels-Portfolio/"
