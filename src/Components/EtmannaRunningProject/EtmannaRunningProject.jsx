...
import logo from "../../assets/etmanna-logo.png";
import img from "../../assets/etmanna.png";
import style from "./EtmannaRunningProject.module.css";
import { HiArrowRightCircle } from "react-icons/hi2";
import { HiArrowLongRight } from "react-icons/hi2";
import { HiArrowLongLeft } from "react-icons/hi2";

export default function EtmannaRunningProject() {
  return (
          ...
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
                ...
                <li>
                  ...
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">
                    Create Discount Code
                          ...
                          <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">
                  Export & Import products (ExcelSheet)
                  </span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                Developed a fully responsive Shopify website that provides a
                seamless experience across desktop, tablet, and mobile devices,
                Built custom sections using code to enhance flexibility and
                create a fully tailored user experience, Implemented design and
                functionality improvements to optimize performance and user
                engagement.
              </p>
            </div>
