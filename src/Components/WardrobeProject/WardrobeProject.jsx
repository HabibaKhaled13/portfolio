...
import img from "../../assets/wardrobe.png";
import style from "./WardrobeProject.module.css";
          ...
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                Developed a fully responsive e-commerce store using EasyOrders,
                customizing the platform with advanced code modifications to
                achieve a seamless and personalized user experience. Added
                products and categories, configured discount codes, and
                integrated a WhatsApp chat button to enhance customer
                communication. The project delivers smooth performance across
                all devices with a clean, optimized shopping flow.
              </p>
            </div>

            <div className="btn mt-5">
              <Link
                to="https://www.wardrobeeg.com/"
