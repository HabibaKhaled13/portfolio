...
import img from "../../assets/elsafer.png";
import style from "./ElsaferProject.module.css";
import { HiArrowRightCircle } from "react-icons/hi2";
import { HiArrowLongRight } from "react-icons/hi2";
import { HiArrowLongLeft } from "react-icons/hi2";

export default function ElsaferProject() {
  return (
          ...
          <div className="md:w-[35%] w-full md:sticky top-0  p-7 rounded-2xl bg-[#F5F4EF]">
            ...
            <div className="details-of-project pt-10">
              ...
              <p className="text-neutral-600 mt-3 mb-6">
                A modern and responsive landing page for domestic recruitment
                services, designed to connect families with trusted and
                qualified domestic workers. The page highlights available
                services, worker profiles, hiring procedures, and contact
                options, ensuring a smooth and secure experience for both
