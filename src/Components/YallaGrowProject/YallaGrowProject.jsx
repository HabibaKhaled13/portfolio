...
import img from "../../assets/yallagrow.png";
import style from "./YallaGrowProject.module.css";
import { HiArrowRightCircle } from "react-icons/hi2";
import { HiArrowLongRight } from "react-icons/hi2";
import { HiArrowLongLeft } from "react-icons/hi2";

export default function YallaGrowProject() {
  return (
...
<div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-y-5">
            ...
            <div className="logo-of-project my-6">
              <img src={logo} alt="yalla grow company" width={80} />
            </div>

            <div className="techtools">
              <ul className="text-[11px] text-neutral-500 flex flex-wrap gap-2">
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">Next.js</span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">Typescript</span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">Tailwind</span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">Gsap</span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">Shadcn ui</span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">React Slick</span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">React-icons</span>
                </li>
                <li>
                  <span className="inline-block py-1 px-4 bg-[#ECEAE6] rounded-full">react-fast-marquee</span>
                </li>
              </ul>
            </div>
            ...
            <div className="details-of-project pt-10">
             ...
             A marketing and training company offering creative marketing solutions and practical courses to boost your business and career.
              </p>
            </div>

       <div className="btn mt-5">
                <Link
                  to="https://yallagrow.pro/"
